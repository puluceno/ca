...
//
/**
 * We are not generating the files anymore, we have them locally and they are
 * being served by an apache server
 * 
 * @author pulu
 */
@Deprecated
public class PDFGenerator {
	...
	//
	// public static HttpServletResponse getPDF(Response res, Document ca)
	// throws
	// Exception {
	...
	// raw.addHeader("Content-Disposition", "attachment; filename=" +
	// ca.getString("number") + ".pdf");
	...
	// JRLoader.loadObject(getClass().getResourceAsStream(CA_FILE));
	//
	// // Parameters for report
	// Map<String, String> companyInfo =
	// CNPJService.getCompanyInfo(ca.getString("cnpj"));
	...
	//
	// JasperPrint print = JasperFillManager.fillReport(jasperReport, ca,
	// dataSource);
	//
	// // Export to PDF.
	// String fileName = ca.getString("number") + ".pdf";
	...
	//
	// Logger.info("PDF file {} generated in {}", fileName, (new
	// Date().getTime() -
	// begin) + "ms.");
	//
	// } catch (Exception e) {
