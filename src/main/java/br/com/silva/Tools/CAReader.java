	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i <= reader.getNumberOfPages(); i++) {
			...
			if (page.contains("Cores: "))
				colors = page.substring(page.indexOf("Cores: ") + 7, page.indexOf("Normas técnicas: ") - 1);
			ca.setColors(colors);

			String techRules = page.substring(page.indexOf("Normas técnicas: ") + 17, page.indexOf("Laudos:") - 1);
			...
			if (page.contains("Tabela de Atenuação")) {
				...
				String[] devs = page.substring(page.indexOf("Desvio Padrão: ") + 14, page.lastIndexOf("\n")).split(" ");
